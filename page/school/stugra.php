...
<div class="stuTable layui-form">
    <div class="layui-form-item">
        ...
        <div class="layui-btn-group">
            <button class="layui-btn" data-type="gra">毕业申请</button>
        </div>
    </div>
</div>
...
<script>
    layui.use(['table'], function(){
        ...
        table.render({
            elem: '#LAY_table_stu'
            ,url: '../doAction.php?act=stulist&user=<?php echo $_SESSION['username']?>&reg=2&gra=1'
            ,cols: [[
        ...
        var $ = layui.$, active = {
            gra:function () {
                ...
                layer.confirm('真的要申请毕业么', function(index){
                    $.ajax({
