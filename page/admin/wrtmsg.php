    ...
    <div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <select name="receiver" id="uselect" lay-verify="required" lay-search="">
...
<script>
    ...
    function loadSelect() {
        $.ajax({
            url:"../doAction.php?act=uselect",
            type: "POST",
            dataType:'json',
            success:function (data) {
                var root=document.getElementById("uselect");
