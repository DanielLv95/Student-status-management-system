...
<div class="stuTable layui-form">
    <div class="layui-form-item">
        ...
        <div class="layui-btn-group">
            <button class="layui-btn" data-type="reg">同意注册</button>
        </div>
    </div>
</div>
...
<script>
    layui.use(['table'], function(){
        ...
        table.render({
            elem: '#LAY_table_stu'
            ,url: '../doAction.php?act=stulist&user=<?php echo $_SESSION['username']?>&reg=3'
            ,cols: [[
        ...
        var $ = layui.$, active = {
            reg:function () {
                ...
                layer.confirm('真的要同意注册么', function(index){
                    $.ajax({
                        url: "../doAction.php?act=reg",
